import 'package:doyumluk/views/anasayfa.dart';
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                }, child: Text("GİRİŞ",style: TextStyle(color: Colors.redAccent),),style: ElevatedButton.styleFrom(primary: Colors.white),),
              )
            ],
          ),
        ),
